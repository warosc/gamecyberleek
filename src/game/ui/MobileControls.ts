...
export class MobileControls {
  ...
  create() {
    ...
    this.scene.add.text(moveCenter.x, moveCenter.y + 88, 'MOVE', { fontFamily: 'Arial Black', fontSize: '10px', color: '#8fcbd6' }).setOrigin(.5).setDepth(61);
    this.scene.add.text(aimCenter.x, aimCenter.y + 88, 'AIM / FIRE', { fontFamily: 'Arial Black', fontSize: '10px', color: '#ff9caf' }).setOrigin(.5).setDepth(61);
